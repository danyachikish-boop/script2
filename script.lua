-- кто взломает или изменит код тот лох!
...
SettingsTab:Button({
    ...
    Desc = "Загружает первую картинку из workspace/ratnik hub",
    Callback = function()
        ...
        if not targetFile then
            WindUI:Notify({ 
                ...
                Content = "Положи картинку (.png/.jpg) в папку workspace/ratnik hub", 
                Duration = 4, 
                Icon = "file-warning" 
            })
            return
